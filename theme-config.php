    ...
    class Redux_Framework_sample_config {
        ...
        public function setSections() {
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					'subtitle' => __('Select the image file of your company or business logo.', 'redux-framework-demo'),
					'default'  => array(
					...
					array(
						'id'               => 'hotline',
						'type'             => 'editor',
						'title'            => __('Hotline Area Content', 'redux-framework-demo'),
						'subtitle'         => __('Enter content to show in header top right corner.', 'redux-framework-demo'),
						'args'   => array(
							'teeny'            => true,
							'textarea_rows'    => 10
						)
        ...
        public function setArguments() {
            ...
            $this->args = array(
                ...
                'opt_name'          => 'stardev',            // This is where your data is stored in the database and also becomes your global variable name.
